...
public class Module {
    ...
    public void onEnable() {
        Mystra.instance.eventManager.register(this);
    }
    public void onDisable() {
    	Mystra.instance.eventManager.unregister(this);
    }
    ...
    public Module module(final String mod) {
        return Mystra.instance.moduleManager.getModuleByName(mod);
    }
    ...
    public Setting setting(final String set) {
        return Mystra.instance.settingsManager.getSettingByName(set);
    }
