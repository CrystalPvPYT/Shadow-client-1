...
public class GuiTexturedButton extends GuiButton {
	...
	public void drawButton(Minecraft mc, int mouseX, int mouseY) {
		...
		Mystra.RENDER2D.rect(-width / 2, -height / 2, width, height, new Color(0, 0, 0, 150));
		...
		if (!displayString.isEmpty())
			Mystra.fontManager.getFont("SFL 10").drawString(displayString, xPosition + width / 2 - Mystra.fontManager.getFont("SFL 10").getWidth(displayString) /  2, yPosition + height / 2 - Mystra.fontManager.getFont("SFL 10").getHeight(displayString) / 2, -1);
