...
import me.mystra.utils.gui.easings.Back;
import me.mystra.utils.gui.easings.Bounce;
import me.mystra.utils.gui.easings.Circ;
import me.mystra.utils.gui.easings.Cubic;
import me.mystra.utils.gui.easings.Elastic;
import me.mystra.utils.gui.easings.Expo;
import me.mystra.utils.gui.easings.Linear;
import me.mystra.utils.gui.easings.Quad;
import me.mystra.utils.gui.easings.Quart;
import me.mystra.utils.gui.easings.Quint;
import me.mystra.utils.gui.easings.Sine;
...
public class AnimationUtil {
	...
	public final double easeIn(Progression progression, double startValue, double endValue, double duration) {
		...
		if (progression.getValue() < duration) progression.setValue((progression.getValue() + (Mystra.DELTA_UTIL.deltaTime * .001F)));
	...
	public static final double slide(double current, double min, double max, double speed, boolean sliding) {
		speed *= Mystra.DELTA_UTIL.deltaTime * .2;
