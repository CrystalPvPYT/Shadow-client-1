package me.mystra.gui.altmanager.components;
...
public class GuiAccountList extends GuiSlot {
	...
	public int getSize() {
		return Mystra.instance.getAccountManager().getAccounts().size();
	}
	...
	public Account getAccount(int i) {
		return Mystra.instance.getAccountManager().getAccounts().get(i);
	}
	...
	public void removeSelected() {
		if (this.selected == -1)
			return;
		Mystra.instance.getAccountManager().getAccounts().remove(getAccount(this.selected));
