package me.mystra.gui.altmanager.impl;
...
public class GuiAlteningLogin extends GuiScreen {
	...
	protected void actionPerformed(GuiButton button) {
		...
		case -1:
			if (key.getText().isEmpty() || token.getText().isEmpty())
				return;
			Mystra.instance.getAccountManager().setAlteningKey(key.getText());
			Mystra.instance.getAccountManager().setLastAlteningAlt(token.getText());
		...
		case 2:
			...
			break;
		case 3:
			if (key.getText().isEmpty() || Mystra.instance.getAccountManager().getLastAlteningAlt() == null)
				return;
			Mystra.instance.getAccountManager().setAlteningKey(key.getText());
			thread = new AccountLoginThread(Mystra.instance.getAccountManager().getLastAlteningAlt().replaceAll(" ", ""), "gaymer");
			thread.run();
			Mystra.instance.getAccountManager().save();
			break;
		}
	...
	public void initGui() {
		...
		if (Mystra.instance.getAccountManager().getAlteningKey() != null)
			key.setText(Mystra.instance.getAccountManager().getAlteningKey());
