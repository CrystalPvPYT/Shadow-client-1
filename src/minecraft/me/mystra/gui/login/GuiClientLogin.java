...
import me.mystra.gui.login.elements.textfields.GuiTextBoxLogin;
import me.mystra.utils.gui.ClipboardUtil;
...
public class GuiClientLogin extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		Mystra.fontManager.getFont("SFL 10").drawStringWithShadow("To copy the store link", (width - Mystra.fontManager.getFont("SFL 10").getWidth("To copy the store link")) / 2, height / 2 - 75, -1);
	...
	protected void actionPerformed(GuiButton button) throws IOException {
		...
		if (button.id == 0) {
			if (loginBox.getText().isEmpty()) {
				...
				ClipboardUtil.copyToClipboard("mystraclient.store");
		}
