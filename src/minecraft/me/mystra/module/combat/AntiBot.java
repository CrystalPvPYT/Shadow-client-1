...
public class AntiBot extends Module {
    public AntiBot() {
        ...
        Mystra.instance.settingsManager.rSetting(new Setting("AntiBot Mode", this, "Watchdog", options));
    }

    @EventTarget
    public void onUpdate(EventUpdate event) {
    	String mode = Mystra.instance.settingsManager.getSettingByName("AntiBot Mode").getValString();
