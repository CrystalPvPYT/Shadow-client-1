...
public class Reach extends Module {
	...
	public Reach() {
		...
		Mystra.instance.settingsManager.rSetting(new Setting("RANGE", this, 3.2D, 3.0D, 6.0D, false));
	}
	...
	public static Minecraft getMinecraft() {
	   ...
	   public double getDistance() {
		     return Mystra.instance.settingsManager.getSettingByName("RANGE").getValDouble();
	   }
}
