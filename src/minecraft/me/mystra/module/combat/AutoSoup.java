...
public class AutoSoup extends Module {
	...
	public AutoSoup() {
		...
		Mystra.instance.settingsManager.rSetting(new Setting("Health", this, 10, 0, 20, true));
	}
	@EventTarget
	public void onPreMotion(EventPreMotionUpdate event) {
		if (mc.thePlayer.getHealth() / mc.thePlayer.getMaxHealth() * 20 < Mystra.instance.settingsManager.getSettingByName("Health").getValDouble()) {
