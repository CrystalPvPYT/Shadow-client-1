...
public class Criticals extends Module {
    ...
    public Criticals() {
        ...
        options.add("Hypixel");
        Mystra.instance.settingsManager.rSetting(new Setting("Criticals Mode", this, "Hypixel", options));
    }
    ...
    public void onUpdate(EventUpdate event) {
        ...
        if(mode.equalsIgnoreCase("Hypixel")) {
        	if (getMc().thePlayer.motionY < 0 && isBlockUnder() && getMc().thePlayer.onGround && !Mystra.instance.moduleManager.getModuleByName("Speed").isToggled() && !Mystra.instance.moduleManager.getModuleByName("Fly").isToggled() && !getMc().gameSettings.keyBindJump.isKeyDown() && getMc().thePlayer.fallDistance == 0) {
