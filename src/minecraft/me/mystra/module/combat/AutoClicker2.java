...
public class AutoClicker2 extends Module {
	...
	public AutoClicker2() {
		...
		ArrayList<String> options = new ArrayList();
	      options.add("Left");
	      options.add("Right");
	      Mystra.instance.settingsManager.rSetting(new Setting("ModInfo", this, true));
	      Mystra.instance.settingsManager.rSetting(new Setting("ACMode", this, "Left", options));
	      Mystra.instance.settingsManager.rSetting(new Setting("Clicks", this, 8.0D, 2.0D, 20.0D, true));
	}
	
	@EventTarget
	public void onUpdate(EventUpdate event) {
	      int delay = (int)Mystra.instance.settingsManager.getSettingByName("Clicks").getValDouble();
	      if (Mystra.instance.settingsManager.getSettingByName("ModInfo").getValBoolean()) {
	      ...
	      String mode = Mystra.instance.settingsManager.getSettingByName("ACMode").getValString();
