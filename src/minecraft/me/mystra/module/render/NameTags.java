...
import me.mystra.management.command.commands.Friend;
import me.mystra.management.command.variables.FriendManager;
import me.mystra.module.Category;
import me.mystra.module.Module;
import me.mystra.utils.render.R2DUtils;
...
public class NameTags extends Module {
	...
	public NameTags() {
		...
		Mystra.instance.settingsManager.rSetting(new Setting("Armor", this, true));
		Mystra.instance.settingsManager.rSetting(new Setting("Bars", this, true));
	}
	...
	public void onRender3D(Event3D render) {
	   ...
	   public void renderNametag(EntityPlayer player, double x, double y, double z) {
	      ...
	      GL11.glDisable(2929);
	      if(!health) {
	    	  Mystra.fontManager.getFont("SFB 12").drawString(this.getPlayerName(player), (float)var16, 0.0F, 15790320);
	      } else if(health) {
	    	  Mystra.fontManager.getFont("SFB 12").drawString(this.getPlayerName(player), (float)(-var13.getStringWidth(String.valueOf(this.getPlayerName(player)) + " " + this.getHealth(player)) / 2), 0.0F, 15790320);
	    	  Mystra.fontManager.getFont("SFB 12").drawString(this.getHealth(player), (float)((var13.getStringWidth(String.valueOf(this.getPlayerName(player)) + " " + this.getHealth(player)) - var13.getStringWidth(this.getHealth(player)) * 2) / 2), 0.0F, this.getHealthColorHEX(player));
	      }

	      GL11.glEnable(2929);
	      if(Mystra.instance.settingsManager.getSettingByName("Armor").getValBoolean()) {
