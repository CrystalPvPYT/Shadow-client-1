...
import me.mystra.utils.ColorUtils;
...
public class ESP2DMod extends Module {
   ...
   public ESP2DMod() {
        ...
        Mystra.instance.settingsManager.rSetting(new Setting("Box Mode", this, "Box", options));
        
		Mystra.instance.settingsManager.rSetting(new Setting("Dropped Items", this, true));
		Mystra.instance.settingsManager.rSetting(new Setting("Local Player", this, true));
		Mystra.instance.settingsManager.rSetting(new Setting("Invisibles", this, true));
		Mystra.instance.settingsManager.rSetting(new Setting("Health Bar", this, true));
		Mystra.instance.settingsManager.rSetting(new Setting("Armor Bar", this, true));
		Mystra.instance.settingsManager.rSetting(new Setting("Outline", this, true));
		Mystra.instance.settingsManager.rSetting(new Setting("Players", this, true));
		Mystra.instance.settingsManager.rSetting(new Setting("Animals", this, true));
		Mystra.instance.settingsManager.rSetting(new Setting("Mobs", this, true));
		Mystra.instance.settingsManager.rSetting(new Setting("Chests", this, true));
		Mystra.instance.settingsManager.rSetting(new Setting("Tag", this, true));
   ...
   public void onEvent(RenderNametagEvent event) {
      if (this.isValid(event.getEntity()) && Mystra.instance.settingsManager.getSettingByName("Tag").getValBoolean()) {
   ...
   public void onRender(RenderGuiEvent event) {
	   String mode = Mystra.instance.settingsManager.getSettingByName("Box Mode").getValString();
      GL11.glPushMatrix();
      ...
      boolean tag = Mystra.instance.settingsManager.getSettingByName("Tag").getValBoolean();
      boolean outline = Mystra.instance.settingsManager.getSettingByName("Outline").getValBoolean();
      boolean health = Mystra.instance.settingsManager.getSettingByName("Health Bar").getValBoolean();
      boolean armor = Mystra.instance.settingsManager.getSettingByName("Armor Bar").getValBoolean();
         ...
         if (this.isValid(entity) && RenderUtils.isInViewFrustrum(entity)) {
            ...
            if (position != null) {
               ...
               if (tag) {
                  ...
                  Mystra.fontManager.getFont("SFL 14").drawStringWithShadow(prefix + name, tagX, tagY, -1);
                  GL11.glPopMatrix();
               }
   ...
   private boolean isValid(Entity entity) {
      if (entity != mc.thePlayer || Mystra.instance.settingsManager.getSettingByName("Armor Bar").getValBoolean() && mc.gameSettings.thirdPersonView != 0) {
         if (entity.isDead) {
            return false;
         } else if (!Mystra.instance.settingsManager.getSettingByName("Invisibles").getValBoolean() && entity.isInvisible()) {
            return false;
         } else if (Mystra.instance.settingsManager.getSettingByName("Dropped Items").getValBoolean() && entity instanceof EntityItem && mc.thePlayer.getDistanceToEntity(entity) < 10.0F) {
            return true;
         } else if (Mystra.instance.settingsManager.getSettingByName("Animals").getValBoolean() && entity instanceof EntityAnimal) {
            return true;
         } else if (Mystra.instance.settingsManager.getSettingByName("Players").getValBoolean() && entity instanceof EntityPlayer) {
            return true;
         } else {
            return Mystra.instance.settingsManager.getSettingByName("Mobs").getValBoolean() && (entity instanceof EntityMob || entity instanceof EntitySlime || entity instanceof EntityDragon || entity instanceof EntityGolem);
         }
      } else {
         return false;
      }
