...
public class Fly extends Module {
    ...
    public Fly() {
        ...
        Mystra.instance.settingsManager.rSetting(new Setting("Fly Mode", this, "Hypixel", options));
        
        Mystra.instance.settingsManager.rSetting(new Setting("Timer Boost", this, true));
        Mystra.instance.settingsManager.rSetting(new Setting("FlyBlink", this, true));
        Mystra.instance.settingsManager.rSetting(new Setting("View Bobbing", this, true));
        Mystra.instance.settingsManager.rSetting(new Setting("Timer Speed", this, 2.4F, 1F, 6F, false));
    }
    ...
    public void onUpdate(EventUpdate event) {
    	...
    	String mode = Mystra.instance.settingsManager.getSettingByName("Fly Mode").getValString();
        ...
        if(mode.equalsIgnoreCase("Hypixel")) {
        	if(Mystra.instance.settingsManager.getSettingByName("Timer Boost").getValBoolean()) {
        		mc.timer.timerSpeed = (float) Mystra.instance.settingsManager.getSettingByName("Timer Speed").getValDouble();
        	}
        	if(Mystra.instance.settingsManager.getSettingByName("View Bobbing").getValBoolean()) {
    ...
    public void drawBox(BlockPos pos, int multiplier, Color color) {
        ...
        if (block != null) {
            ...
            Mystra.RENDER3D.drawAxisAlignedBBFilled(axisAlignedBB, color, true);
        }
    }
    ...
    public void onDisable() {
    	String mode = Mystra.instance.settingsManager.getSettingByName("Fly Mode").getValString();
    	mc.timer.timerSpeed = 1F;
    	if(Mystra.instance.settingsManager.getSettingByName("FlyBlink").getValBoolean()) {
