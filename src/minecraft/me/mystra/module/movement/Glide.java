...
public class Glide extends Module{
	...
	public Glide() {
        ...
        Mystra.instance.settingsManager.rSetting(new Setting("Glide Mode", this, "AAC", options));
	}

	@EventTarget
	public void onUpdate(EventUpdate event) {
		
		String mode = Mystra.instance.settingsManager.getSettingByName("Glide Mode").getValString();
