...
public class Scaffold extends Module {
	...
	public Scaffold() {
        ...
        Mystra.instance.settingsManager.rSetting(new Setting("Scaffold Mode", this, "Hypixel", options));
		
		Mystra.instance.settingsManager.rSetting(new Setting("Tower Speed", this, 0.42, 0.1, 1, false));
		Mystra.instance.settingsManager.rSetting(new Setting("Tower", this, false));
		Mystra.instance.settingsManager.rSetting(new Setting("Silent", this, false));
		Mystra.instance.settingsManager.rSetting(new Setting("KeepY", this, false));
		Mystra.instance.settingsManager.rSetting(new Setting("SafeWalk", this, false));
		Mystra.instance.settingsManager.rSetting(new Setting("SRotations", this, true));
		Mystra.instance.settingsManager.rSetting(new Setting("BlockCount", this, true));
	}
	@EventTarget
	public void onUpdate(EventUpdate event) {
		String mode = Mystra.instance.settingsManager.getSettingByName("Scaffold Mode").getValString();
			...
			if(isValidBlock(playerBlock.add(0, -2, 0))) {
				if(Mystra.instance.settingsManager.getSettingByName("Tower").getValBoolean()) {
					if(mc.gameSettings.keyBindJump.pressed) {
						mc.thePlayer.motionY = Mystra.instance.settingsManager.getSettingByName("Tower Speed").getValDouble();;
		...
		if (mc.thePlayer.getHeldItem() == null || !(mc.thePlayer.getHeldItem().getItem() instanceof ItemBlock)) {
			for (int i = 0; i < 9; i++) {
				...
				if (item != null && item.getItem() instanceof ItemBlock) {
		            ...
		            if(!Mystra.instance.settingsManager.getSettingByName("Silent").getValBoolean()) {
	...
	public void onSendPacket(EventSendPacket event) {
		...
		if(packet instanceof C03PacketPlayer)
            if(Mystra.instance.settingsManager.getSettingByName("SRotations").getValBoolean()) {
	...
	public void onSafewalk(EventSafeWalk event) {
		if(Mystra.instance.settingsManager.getSettingByName("SafeWalk").getValBoolean()) {
			if (getMc().thePlayer != null)
				event.setCancelled(Mystra.instance.settingsManager.getSettingByName("KeepY").getValBoolean() ? (!getMc().gameSettings.keyBindJump.isKeyDown() && getMc().thePlayer.onGround) : getMc().thePlayer.onGround);
		}
	}
