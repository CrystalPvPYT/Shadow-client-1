...
public class InventoryHelper extends Module {
	...
	public InventoryHelper() {
		...
		Mystra.instance.settingsManager.rSetting(new Setting("InvCleaner Delay", this, 135, 0.0, 500, true));
	}
	...
	public void onPreMotion(EventUpdate event) {
		...
		if (isToggled()) {
				...
				if(timer.hasReached((long) Mystra.instance.settingsManager.getSettingByName("InvCleaner Delay").getValDouble())){
				for (int o = 0; o < 45; ++o) {
