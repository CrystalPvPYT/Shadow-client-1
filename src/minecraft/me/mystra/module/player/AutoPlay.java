...
public class AutoPlay extends Module {
    ...
    public AutoPlay() {
        ...
        Mystra.instance.settingsManager.rSetting(new Setting("AutoPlay Mode", this, "Solo Insane", options));
    }


    private String getServerMessage() {
    	String mode = Mystra.instance.settingsManager.getSettingByName("AutoPlay Mode").getValString();
