package me.mystra.cosmetics.impl;

import org.lwjgl.opengl.GL11;

import me.mystra.Mystra;
import me.mystra.cosmetics.CosmeticBase;
import me.mystra.cosmetics.CosmeticController;
import me.mystra.cosmetics.CosmeticModelBase;
...
public class CosmeticTopHat extends CosmeticBase {
	...
	private static final ResourceLocation TEXTURE = new ResourceLocation("mystra/hat.png");
	...
	private class ModelTopHat extends CosmeticModelBase {
		...
		public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float headYaw, float headPitch, float scale) {
			if(Mystra.instance.moduleManager.getModuleByName("Cosmetics").isToggled()) {
				if(Mystra.instance.settingsManager.getSettingByName("Hat").getValBoolean()) {
