package me.mystra.clickgui.clickgui.elements;
...
import me.mystra.clickgui.clickgui.Panel;
import me.mystra.clickgui.clickgui.elements.menu.ElementCheckBox;
import me.mystra.clickgui.clickgui.elements.menu.ElementComboBox;
import me.mystra.clickgui.clickgui.elements.menu.ElementSlider;
...
public class ModuleButton {
	...
	public ModuleButton(Module imod, Panel pl) {
		 ...
		 */
		if (Mystra.instance.settingsManager.getSettingsByMod(imod) != null)
			for (Setting s : Mystra.instance.settingsManager.getSettingsByMod(imod)) {
				if (s.isCheck()) {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		String thememodulebutton = Mystra.instance.settingsManager.getSettingByName("Theme").getValString();
		int textcolor = 0xffafafaf;
		if (mod.isToggled()) {
			if(thememodulebutton.equalsIgnoreCase("Mystra")) {
	...
	public boolean mouseClicked(int mouseX, int mouseY, int mouseButton) {
		...
		if (mouseButton == 0) {
			...
			if (menuelements != null && menuelements.size() > 0) {
				...
				Mystra.instance.clickGui.closeAllSettings();
				this.extended = b;
