package me.mystra.clickgui.clickgui;
...
public class Panel {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		String themepanel = Mystra.instance.settingsManager.getSettingByName("Theme").getValString();
		if(Mystra.instance.settingsManager.getSettingByName("Design").getValString().equalsIgnoreCase("Mystra")){
			if(themepanel.equalsIgnoreCase("Mystra")) {
		...
		if (this.extended && !Elements.isEmpty()) {
			...
			int epanelcolor = Mystra.instance.settingsManager.getSettingByName("Design").getValString().equalsIgnoreCase("Mystra") ? 0x99232323 : Mystra.instance.settingsManager.getSettingByName("Design").getValString().equalsIgnoreCase("New") ? 0x99232323 : 0; ;
